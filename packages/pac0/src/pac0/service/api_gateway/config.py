...
class UpstreamConfig(BaseModel):
    ...
    api_key: Optional[str] = Field(None, description="API key for upstream authentication")
...
class ProxyConfig(BaseModel):
    ...
    upstream: UpstreamConfig = Field(default_factory=lambda: UpstreamConfig(endpoint=""), description="Upstream API configuration")
    store: StoreConfig = Field(default_factory=StoreConfig, description="Storage configuration")
