...
* [superpdp](https://www.superpdp.tech/documentation/9/) api [directory](https://www.superpdp.tech/openapi/#afnor-directory) et api [flow](https://www.superpdp.tech/openapi/#afnor-flow)

## tests via scalar

L'outil [API client scalar](https://github.com/scalar/scalar) permets de tester des appels API en définissant de [multiples sources](https://scalar.com/products/api-references/integrations/fastapi#multiple-openapi-sources). On pourrait ainsi y faire figurer les différentes API recensées.
