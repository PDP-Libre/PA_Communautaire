...
#export UV_INDEX_URL=https://git.pdplibre.org/api/packages/philippe.entzmann/pypi/simple
# on indique le registry python egalement
...
#❯ export UV_PUBLISH_URL=https://git.pdplibre.org/api/packages/philippe.entzmann/pypi
# a token with package `read and write` role
...
Package visible sur https://git.pdplibre.org/philippe.entzmann/-/packages
